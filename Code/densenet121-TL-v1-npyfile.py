...
wandb.init(project="minor-project-DN121v1", entity="minor-project")
...
# Function with the model architecture of Transfer Learning with DenseNet121_Model architecture
...
# Printing model summary information
# model.summary()
...
modelPath = './saved Models/Pretrained DenseNet121'
...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint('./saved Models/Pretrained DenseNet121/DenseNet121-best-model.h5', monitor='val_categorical_accuracy',
...
tf.keras.models.save_model(model, './saved Models/Pretrained DenseNet121/DenseNet121-model.h5', overwrite=True, include_optimizer=True, save_format=None,
...
plt.title('PretrainedDenseNet121 Train/Test Loss')
plt.ylabel('Loss')
plt.xlabel('Number of Epochs')
plt.legend(loc="upper left")
plt.savefig('./Train-Test History/Loss/DenseNet121-loss-Graph.png', bbox_inches = "tight")
...
plt.title('PretrainedDenseNet121 Train/Test Accuracy')
plt.ylabel('Accuracy')
plt.xlabel('Number of Epochs')
plt.legend(loc="upper left")
plt.savefig('./Train-Test History/Accuracy/DenseNet121-Accuracy-Graph.png', bbox_inches = "tight")
print("Accuracy graph saved to Train-Test History/Accuracy directory")
# plt.show()

# Evaluate the Best Saved Model
model = tf.keras.models.load_model('./saved Models/Pretrained DenseNet121/DenseNet121-model.h5')
...
def plot_confusion_matrix(cm, target_names, title='Confusion matrix', cmap=None, normalize=True):
    ...
    plt.savefig('./Train-Test History/ConfusionMatrix/DenseNet121-cm.png', bbox_inches = "tight")
